          ...
          <section data-v-26153660="" class="mobile-header d-lg-none d-xl-none">
              <div data-v-26153660="" class="col-4 mobile-header-col left vue-portal-target">
                  ...
                  <a data-v-26153660="" href="/?from=logo" class="left-logo">
                      <img data-v-26153660="" src="https://assets.cdn.soomgo.com/icons/logo/navigation_logo.svg" alt="숨고 로고" data-testid="main-logo">
                  </a>
              </div>
          </section>
          ...
          <section data-v-26153660="" class="d-none d-lg-block d-xl-block">
              <div data-v-26153660="" class="desktop-header">
                  <div data-v-26153660="" class="left-section">
                      ...
                      <nav data-v-26153660="">
                          <ul data-v-26153660="" class="nav-list">
                              ...
                              <li data-v-26153660="" class="nav-item left-section-item">
                                  <router-link to="/community/post-all" class="gnb-link">
                          ...
                          <ul data-v-26153660="" class="nav-list">
                              <li data-v-26153660="" class="nav-item right-section-item">
                                  <router-link to="/login">
                                      <span data-v-26153660="">로그인</span>
                                  </router-link>
                              </li>
                              <li data-v-26153660="" class="nav-item right-section-item">
                                  <router-link to="/signup/customer">
                                      <span data-v-26153660="">회원가입</span>
                                  </router-link>
                              </li>
                          </ul>
                      </nav>
                  ...
                  <div v-show="userStatus == true" data-v-26153660="" class="right-section">
                      ...
                      <div data-v-4c66cf88="" data-v-26153660="" class="notification-counter notification-counter right-section-item">
                      ...
                      <div data-v-35a09b99="" data-v-26153660="" class="usermenu user-menu right-section-item">
                          ...
                          <div data-v-35a09b99="" class="usermenu-dropdown" style="display: none;">
                              ...
                              <div data-v-35a09b99="" class="logout"><button data-v-35a09b99="" type="button" class="btn btn-secondary btn-sm">로그아웃</button></div>
                          </div>
                      </div>
                  </div>
              </div>
